      ...
      <div className="center">
        {location.protocol.startsWith("https") && (
          <div className="warning">
            You are viewing this page using HTTPS. This means by default, you
        ...
        <div>
          ...
          <div className="description">
            ...
            Sound Voltex is running on. This will create a locally running
            server on port 4573. To verify that the server is running, navigate
            to <a href="http://localhost:4573">http://localhost:4573</a>.
            <br />
            Note that you can access this on your local network by using your
            computer's local IP, or from outside of your local network if you
            set up port forwarding appropriately.
          </div>
        ...
        <div className="description">
          Provides a central location to configure your app settings. To
          configure within OBS, add this page as a browser source, right click
          the source and select <b>Interact</b>.
        </div>
        <div className="endpoint">
          <a href="/obs">/obs</a>
        </div>
        <div className="description">
          ...
          display based on in-game UI. For this, you must enable websockets in
          OBS (<b>Tools -&gt; WebSocket Server Settings</b>) and configure OBS
